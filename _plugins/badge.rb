  ...
  module Badge
    class Main < Liquid::Tag
      ...
      def render(context)
        ...
        %(<span style="font-size: #{fsize}; color: black; font-weight: 200; background-color: #d6d6d6;" class="p-2 my-2 badge badge-secondary layout_resume__badge">#{skill}</span>)
      end
...
Liquid::Template.register_tag('badge', Jekyll::Badge::Main)
